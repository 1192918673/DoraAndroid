 ...
 */
public class UserResetPwd2 extends BaseActivity implements IResetPwd2View {
    ...
    private void initListener() {
        ...
        etPwd2.setOnFocusChangeListener(focusChangeListener);
    }
    ...
    public void goBack() {
        hideDialog();
        startActivity(new Intent(UserResetPwd2.this,UserResetPwd.class));
        this.finish();
    }
    ...
    public void toLogin() {
        ...
        startActivity(new Intent(UserResetPwd2.this,IndexActivity.class));
        this.finish();
    }
