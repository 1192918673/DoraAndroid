 ...
 */
public class UserResetPwd extends BaseActivity implements IResetPwdView {
    ...
    public void toPwd2(String token) {
        ...
        Intent intent = new Intent(UserResetPwd.this,UserResetPwd2.class);
    ...
    public void toUserLoginActivity() {
        hideDialog();
        startActivity(new Intent(UserResetPwd.this,UserLoginActivity.class));
        this.finish();
    }
