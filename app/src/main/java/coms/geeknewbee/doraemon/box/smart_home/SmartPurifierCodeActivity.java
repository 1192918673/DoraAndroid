...
public class SmartPurifierCodeActivity extends BaseActivity
    implements ViewListener, SurfaceHolder.Callback, ISmartView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smart_purifier_code);
        assignViews();
    ...
    public void addSuccess() {
        hideDialog();
        Intent intent =
                new Intent(SmartPurifierCodeActivity.this, SmartPurifierSuccessActivity.class);
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ...
            showDialog("扫码成功，正在连接设备……");
            serialNo = resultString;
